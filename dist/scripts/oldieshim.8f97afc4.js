!function(a, b) {
    ...
    function a() {}
    function b(a) {
        return a = +a, a !== a ? a = 0 : 0 !== a && a !== 1 / 0 && a !== -(1 / 0) && (a = (a > 0 || -1) * Math.floor(Math.abs(a))), 
        a;
    }
    function c(a) {
        var b = typeof a;
    ...
    Function.prototype.bind || (Function.prototype.bind = function(b) {
        ...
        return c.prototype && (a.prototype = c.prototype, j.prototype = new a(), a.prototype = null), 
        j;
    });
    var n, o, p, q, r, s = e.bind(g.hasOwnProperty), t = e.bind(g.toString);
    (r = s(g, "__defineGetter__")) && (n = e.bind(g.__defineGetter__), o = e.bind(g.__defineSetter__), 
    p = e.bind(g.__lookupGetter__), q = e.bind(g.__lookupSetter__)), 2 !== [ 1, 2 ].splice(0).length && (Array.prototype.splice = function() {
        function a(a) {
            for (var b = []; a--; ) b.unshift(a);
            return b;
        }
        var b, c = [];
        return c.splice.bind(c, 0, 0).apply(null, a(20)), c.splice.bind(c, 0, 0).apply(null, a(26)), 
        b = c.length, c.splice(5, 0, "XXX"), b + 1 === c.length ? !0 : void 0;
    }() ? function(a, b) {
        ...
        if (void 0 === a && (a = 0), void 0 === b && (b = this.length - a), e > 0) {
            ...
            return c = h.call(this, a, a + b), d.push.apply(d, h.call(this, a + b, this.length)), 
            d.unshift.apply(d, h.call(this, 0, a)), d.unshift(0, this.length), i.apply(this, d), 
            c;
        }
    ...
    if (Array.prototype.reduce && (x = "object" == typeof Array.prototype.reduce.call("a", function(a, b, c, d) {
        ...
        var y = !{
            ...
            return c || (c = !Array.isArray(b) && null !== a && "object" == typeof a && "number" == typeof a.length && a.length >= 0 && l(a.callee)), 
            c;
        };
    ...
    var F = !1;
    try {
        F = Date.prototype.toJSON && null === new Date(0/0).toJSON() && -1 !== new Date(D).toJSON().indexOf(E) && Date.prototype.toJSON.call({
            toISOString: function() {
                return !0;
            }
        });
    } catch (G) {}
    F || (Date.prototype.toJSON = function() {
    ...
    (!Date.parse || J || I || !H) && (Date = function(a) {
        ...
        f = 1e7, g = 6, h = [ 0, 0, 0, 0, 0, 0 ], Number.prototype.toFixed = function(f) {
            ...
            if (i = "", 0 > h && (i = "-", h = -h), j = "0", h > 1e-21) if (k = e(h * d(2, 69, 1)) - 69, 
            l = 0 > k ? h * d(2, -k, 1) : h / d(2, k, 1), l *= 4503599627370496, k = 52 - k, 
            k > 0) {
            ...
            return g > 0 ? (n = j.length, j = g >= n ? i + "0.0000000000000000000".slice(0, g - n + 2) + j : i + j.slice(0, n - g) + "." + j.slice(n - g)) : j = i + j, 
            j;
        };
    }();
    ...
    2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || "".split(/.?/).length || ".".split(/()()/).length > 1 ? !function() {
        ...
        String.prototype.split = function(b, c) {
            ...
            for (b = new RegExp(b.source, j + "g"), d += "", a || (e = new RegExp("^" + b.source + "$(?!\\s)", j)), 
            c = void 0 === c ? -1 >>> 0 : c >>> 0; (f = b.exec(d)) && (g = f.index + f[0].length, 
            !(g > k && (i.push(d.slice(k, f.index)), !a && f.length > 1 && f[0].replace(e, function() {
            ...
            h = f[0].length, k = g, i.length >= c))); ) b.lastIndex === f.index && b.lastIndex++;
    ...
    function a(b, d) {
        ...
        if (!f("json")) {
            ...
            if ((o = i.hasOwnProperty) || (o = function(a) {
                ...
                } : (e = "valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "), 
                p = function(a, b) {
                    var d, f = "[object Function]" == r.call(a), g = !f && "function" != typeof a.constructor && c[typeof a.hasOwnProperty] && a.hasOwnProperty || o;
                ...
                d.stringify = function(a, b, d) {
                    var e, f, g, h;
                    if (c[typeof b] && b) if ("[object Function]" == (h = r.call(b))) f = b; else if ("[object Array]" == h) {
                        g = {};
                        for (var i, j = 0, k = b.length; k > j; i = b[j++], h = r.call(i), ("[object String]" == h || "[object Number]" == h) && (g[i] = 1)) ;
                    }
                    if (d) if ("[object Number]" == (h = r.call(d))) {
                        if (0 < (d -= d % 1)) for (e = "", d > 10 && (d = 10); e.length < d; e += " ") ;
